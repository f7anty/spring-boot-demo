...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
        ...
        //swagger接口权限 开放
        filterChainDefinitionMap.put("/swagger-ui.html", DefaultFilter.anon.name());
        filterChainDefinitionMap.put("/webjars/**", DefaultFilter.anon.name());
        filterChainDefinitionMap.put("/v2/**", DefaultFilter.anon.name());
        filterChainDefinitionMap.put("/swagger-resources/**", DefaultFilter.anon.name());
    ...
    public RedisCacheManager shiroCacheManager() {
        ...
        shiroCacheManager.setKeyPrefix("api_shiro_cache:");
        shiroCacheManager.setRedisManager(redisManager());
